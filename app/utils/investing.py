...
async def get_not_full_invested_objects(
    obj_in: CharityProject | Donation,
...
async def close_donation_for_obj(obj_in: CharityProject | Donation):
...
async def invest_money(
    obj_in: CharityProject | Donation,
    obj_model: CharityProject | Donation,
...
async def investing(
    obj_in: CharityProject | Donation,
    model_add: CharityProject | Donation,
    session: AsyncSession,
) -> CharityProject | Donation:
